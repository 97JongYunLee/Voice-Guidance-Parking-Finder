...
def draw_detections(frame, detections, palette, labels, output_transform):
    ...
    f=open("C:/Users/AIoT14/test/open_model_zoo-master/demos/text_to_speech_demo/python/text-to-speech_test.txt",'w')
...
def main():
    ...
    for i in range(1,6): 
        args.model="C:/Users/AIoT14/test/open_model_zoo/demos/object_detection_demo/python/intel/vehicle-detection-0202/FP16/vehicle-detection-0202.xml "
        args.architecture_type='ssd'
        args.adapter="openvino"
        # args.input="C:/Users/AIoT19/Desktop/img.png"
        args.input="C:/Users/AIoT14/Desktop/park/img{}.png".format(i)
        args.device='CPU'
        args.labels= None
        ...
        args.loop=False
        args.output="C:/Users/AIoT14/Desktop/park/test_0706_reuslt.png"
        args.no_show=None
        ...
        args.model_melgan = 'C:/Users/AIoT14/test/open_model_zoo-master/demos/text_to_speech_demo/python/intel/text-to-speech-en-0001/text-to-speech-en-0001-generation/FP16/text-to-speech-en-0001-generation.xml'
        args.model_duration = 'C:/Users/AIoT14/test/open_model_zoo-master/demos/text_to_speech_demo/python/intel/text-to-speech-en-0001/text-to-speech-en-0001-duration-prediction/FP16/text-to-speech-en-0001-duration-prediction.xml'
        args.model_forward = 'C:/Users/AIoT14/test/open_model_zoo-master/demos/text_to_speech_demo/python/intel/text-to-speech-en-0001/text-to-speech-en-0001-regression/FP16/text-to-speech-en-0001-regression.xml'
        args.out = 'C:/Users/AIoT14/test/open_model_zoo-master/demos/text_to_speech_demo/python/res{}.wav'.format(i)
        args.alpha = 1.0
        args.speaker_id = 19
        ...
        args.input = ['C:/Users/AIoT14/test/open_model_zoo-master/demos/text_to_speech_demo/python/text-to-speech_test.txt']
        ...
        playsound('C:/Users/AIoT14/test/open_model_zoo-master/demos/text_to_speech_demo/python/res{}.wav'.format(i))
